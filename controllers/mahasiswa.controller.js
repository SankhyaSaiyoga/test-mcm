...
const { mahasiswa, Sequelize } = require('../models/index.js');
...
self.getAll = (req, res) => {
  ...
  // kita juga meng-include column mahasiswa yang artinya kita memanggil relasi one to many antara mahasiswa dan mahasiswa. data mahasiswa bisa kita akses dalam json nantinya dengan key mahasiswas (bisa kalian perhatikan yang kita include ini sesuai dengan nama yang kita deklarasikan pada model mahasiswa)
  mahasiswa.findAll(
    {
      include: [
        'matakuliahs'
